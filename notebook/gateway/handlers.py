...
class WebSocketChannelsHandler(WebSocketHandler, IPythonHandler):
    ...
    def on_message(self, message):
        ...
        print(message)
        print('getway  receive msg-----------------')
        print(message.content.data.get('func'))
        if message.content.data.get('func')== "sync":
            print('直接转发')
...
class GatewayWebSocketClient(LoggingConfigurable):
    ...
    def _connect(self, kernel_id):
        ...
        print("GatewayWebSocketClient start connect")
        self.ws = None
    ...
    def on_open(self, kernel_id, message_callback, **kwargs):
        ...
        print("GatewayWebSocketClient is open")
    ...
    def on_message(self, message):
        ...
        print("GatewayWebSocketClient  on msg")
        if self.ws is None:
            loop = IOLoop.current()
            loop.add_future(
                self.ws_future,
